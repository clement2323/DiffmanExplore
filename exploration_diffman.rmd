...
```{r}
situation_table <- link_table[id_comp %in% c(2,3)]
...
```{r}
situation_table <- link_table[id_comp %in% c(6)]
```
...
```{r}
# list_z1 list of elmentary area of Z1 which union lead to external or internal differenciation
return_risky_z2 <- function(list_z1){
