...
install.packages("gridy_0.1.1.tar.gz", repos = NULL)

library(gridy)


# je dezip le package puios je devtools build dans le Rproj

```


## TO DO :
- régler les dernieres otes(notamment diff_info repertory fantome)
