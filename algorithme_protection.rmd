...
z2_diff <- merge(z2_to_tag_global,z2_to_tag_compo,by ="z2")[tag.x != tag.y]
if(nrow(z2_diff!=0)) {list_z2_color <- z2_diff$z2}
...
proteger_diffman <- function(max_size){
  print(max_size)
  # max_size <- 3
  l2 <- pblapply(comp_to_nb_com$id_comp[100:1975],function(num_comp){
    # num_comp <- 387
    #print(num_comp)
...
z2_to_tag_final <- readRDS("z2_to_tag_4.rds")
