...
il y a un carreau vert de blanchi, ce dernier a t'il été blanchi par Julien sur griddy ?
...
table(sapply(split(emboitement$id_carreau_petit,emboitement$id_carreau_niv6),length))
